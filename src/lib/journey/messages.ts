...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  // <custom:messages>
  abteilungen: { name: "Bitte eine Abteilung auswählen.", jahresbeitrag_erwachsene: "Bitte den Jahresbeitrag für Erwachsene eingeben.", jahresbeitrag_kinder: "Bitte den Jahresbeitrag für Kinder eingeben." },
  mitglieder: { mitgliedsnummer: "Bitte die Mitgliedsnummer eingeben.", vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben.", geburtsdatum: "Bitte das Geburtsdatum eingeben.", eintrittsdatum: "Bitte das Eintrittsdatum eingeben.", status: "Bitte den Mitgliedsstatus wählen.", beitragsklasse: "Bitte die Beitragsklasse wählen.", abteilung: "Bitte eine Abteilung zuweisen." },
  ...
  veranstaltungen: { titel: "Bitte einen Titel eingeben.", datum: "Bitte Datum und Uhrzeit wählen.", ort: "Bitte den Veranstaltungsort eingeben.", status: "Bitte den Status wählen." },
  anmeldungen: { angemeldet_am: "Bitte das Anmeldedatum eingeben.", anzahl_personen: "Bitte die Personenanzahl angeben.", status: "Bitte den Anmeldestatus wählen.", veranstaltung: "Bitte eine Veranstaltung auswählen.", mitglied: "Bitte ein Mitglied auswählen." },
  helferschichten: { bezeichnung: "Bitte eine Bezeichnung für die Schicht eingeben.", beginn: "Bitte den Beginn der Schicht wählen.", ende: "Bitte das Ende der Schicht wählen.", benoetigte_helfer: "Bitte die Anzahl benötigter Helfer eingeben.", veranstaltung: "Bitte eine Veranstaltung auswählen." },
  // </custom:messages>
};
