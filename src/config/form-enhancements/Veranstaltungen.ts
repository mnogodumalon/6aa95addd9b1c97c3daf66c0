...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['titel', 'datum', 'anmeldeschluss', 'ort', 'maximale_teilnehmer', 'kostenbeitrag', 'abteilung', 'status', 'beschreibung'],
  defaults: {
    'datum': { kind: 'todayOffset', days: 14, withTime: true },
    'status': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
    'maximale_teilnehmer': { kind: 'literal', value: 20 },
  },
  computed: {},
};
