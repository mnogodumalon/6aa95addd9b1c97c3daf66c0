// Auto-generated. Per-entity form-enhancements config for "Beiträge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['jahr', 'betrag', { row: ['faellig_am', 'bezahlt_am'] }, 'status', 'zahlungsart', 'mitglied'],
  defaults: {
    'jahr': { kind: 'literal', value: 2026 },
    'betrag': { kind: 'literal', value: 0 },
    'faellig_am': { kind: 'today' },
