...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['mitgliedsnummer', { row: ['vorname', 'nachname'] }, 'geburtsdatum', 'email', 'telefon', { row: ['strasse', 'hausnummer'], cols: '2fr 1fr' }, { row: ['plz', 'ort'], cols: '1fr 2fr' }, 'eintrittsdatum', 'austrittsdatum', 'status', 'beitragsklasse', 'sepa_mandat', 'notizen', 'abteilung'],
  defaults: {
    ...
    'sepa_mandat': { kind: 'literal', value: false },
  },
  computed: {},
};
