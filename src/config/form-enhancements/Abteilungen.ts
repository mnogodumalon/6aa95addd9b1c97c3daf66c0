// Auto-generated. Per-entity form-enhancements config for "Abteilungen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'jahresbeitrag_erwachsene', 'jahresbeitrag_kinder', 'abteilungsleiter'],
  defaults: {
    'name': { kind: 'lookup', key: 'fussball', label: 'Fußball' },
    'jahresbeitrag_erwachsene': { kind: 'literal', value: 0 },
    'jahresbeitrag_kinder': { kind: 'literal', value: 0 },
  },
  computed: {},
};
