...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['angemeldet_am', 'veranstaltung', 'mitglied', 'anzahl_personen', 'status', 'bemerkung'],
  defaults: {
  ...
  computed: {
    '_anmeldung_kostengesamt': { op: 'mul', left: { kind: 'applookup', ownKey: 'veranstaltung', lookupKey: 'kostenbeitrag' }, right: { kind: 'field', key: 'anzahl_personen' } },
  },
};
