...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['veranstaltung', 'mitglied', 'angemeldet_am', 'anzahl_personen', 'status', 'bemerkung'],
  defaults: {
  ...
  computed: {
    '_anmeldung_gesamtkosten': { op: 'mul', left: { kind: 'applookup', ownKey: 'veranstaltung', lookupKey: 'kostenbeitrag' }, right: { kind: 'field', key: 'anzahl_personen' } },
  },
};
