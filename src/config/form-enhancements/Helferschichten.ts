// Auto-generated. Per-entity form-enhancements config for "Helferschichten".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["bezeichnung", {"row": ["beginn", "ende"]}, "benoetigte_helfer", "veranstaltung", "helfer", "bemerkung"],
  defaults: {
    'beginn': { kind: 'today', withTime: true },
    'ende': { kind: 'today', withTime: true },
  },
  computed: {
    '_schicht_dauer_stunden': { kind: 'dateDiff', from: 'beginn', to: 'ende', unit: 'hours' },
  },
};
