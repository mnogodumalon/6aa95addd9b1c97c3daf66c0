...
// <custom:intent-imports>
import { IconCoinEuro, IconUserCheck, IconUsersGroup } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/jahresbeitraege', label: { de: 'Jahresbeiträge', en: 'Annual fees' }, icon: IconCoinEuro, description: 'Jahresbeiträge für alle aktiven Mitglieder eines Jahres anlegen' },
  { path: '/intents/veranstaltungsanmeldung', label: { de: 'Anmeldung', en: 'Registration' }, icon: IconUserCheck, description: 'Mitglied zu einer Veranstaltung anmelden — mit Kapazitätsprüfung und Warteliste' },
  { path: '/intents/schicht-besetzen', label: { de: 'Schicht besetzen', en: 'Assign shift' }, icon: IconUsersGroup, description: 'Helferschicht einer Veranstaltung mit Mitgliedern besetzen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-15T14:49:21+00:00';
