  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'eintrittsdatum': (
      <div key="eintrittsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="eintrittsdatum"
          placeholder="Wann ist die Person beigetreten?"
          mode="date"
    ...
    'austrittsdatum': (
      <div key="austrittsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="austrittsdatum"
          placeholder="Wann ist die Person ausgetreten?"
          mode="date"
