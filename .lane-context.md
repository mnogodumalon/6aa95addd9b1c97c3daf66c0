...
### `abteilungen` — Abteilungen (type `Abteilungen`, one record: `AbteilungenEntry`)
Display fields: `name`
- `name` · lookup · Name der Abteilung · required! · options: fussball | turnen | tennis | leichtathletik | schach
- `jahresbeitrag_erwachsene` · number · Jahresbeitrag Erwachsene (€) · required! · currency
- `jahresbeitrag_kinder` · number · Jahresbeitrag Kinder (€) · required! · currency
- `abteilungsleiter` · record · Abteilungsleiter · → `mitglieder`
Input shapes: choice `name` (ChoiceGroup)

### `mitglieder` — Mitglieder (type `Mitglieder`, one record: `MitgliederEntry`)
Display fields: `vorname`, `nachname`
- `mitgliedsnummer` · text · Mitgliedsnummer · required! · maxLength 4000
...
- `eintrittsdatum` · date · Eintrittsdatum · required!
- `austrittsdatum` · date · Austrittsdatum
- `status` · lookup · Status · required! · options: aktiv | passiv | ausgetreten
- `beitragsklasse` · lookup · Beitragsklasse · required! · options: erwachsener | kind | familie | ehrenmitglied
- `sepa_mandat` · bool · SEPA-Mandat vorhanden
- `notizen` · textarea · Notizen
- `abteilung` · record · Abteilung · required! · → `abteilungen`
Input shapes: choice `status` (ChoiceGroup); choice `beitragsklasse` (ChoiceGroup)

### `beitraege` — Beiträge (type `Beitraege`, one record: `BeitraegeEntry`)
Display fields: `jahr`
- `jahr` · number · Jahr · required!
- `betrag` · number · Betrag (€) · required! · currency
- `faellig_am` · date · Fällig am · required!
- `status` · lookup · Status · required! · options: offen | bezahlt | erlassen | gemahnt
- `bezahlt_am` · date · Bezahlt am
- `zahlungsart` · lookup · Zahlungsart · options: lastschrift | ueberweisung | bar
- `mitglied` · record · Mitglied · required! · → `mitglieder`
Input shapes: choice `status` (ChoiceGroup); choice `zahlungsart` (ChoiceGroup)

### `veranstaltungen` — Veranstaltungen (type `Veranstaltungen`, one record: `VeranstaltungenEntry`)
Display fields: `titel`
- `titel` · text · Titel · required! · maxLength 4000
- `beschreibung` · textarea · Beschreibung
- `datum` · datetime · Datum und Uhrzeit · required!
- `ort` · text · Ort · required! · maxLength 4000
- `maximale_teilnehmer` · number · Maximale Teilnehmer
- `anmeldeschluss` · date · Anmeldeschluss
- `kostenbeitrag` · number · Kostenbeitrag (€) · currency
- `status` · lookup · Status · required! · options: geplant | offen_anmeldung | ausgebucht | abgesagt | durchgefuehrt
- `abteilung` · record · Abteilung (optional) · → `abteilungen`
...
- `angemeldet_am` · date · Angemeldet am · required!
- `anzahl_personen` · number · Anzahl Personen · required!
- `status` · lookup · Status · required! · options: angemeldet | warteliste | abgemeldet | teilgenommen
- `bemerkung` · textarea · Bemerkung
- `veranstaltung` · record · Veranstaltung · required! · → `veranstaltungen`
- `mitglied` · record · Mitglied · required! · → `mitglieder`
Input shapes: choice `status` (ChoiceGroup)

### `helferschichten` — Helferschichten (type `Helferschichten`, one record: `HelferschichtenEntry`)
Display fields: `bezeichnung`
- `bezeichnung` · text · Bezeichnung · required! · maxLength 4000
- `beginn` · datetime · Beginn · required!
- `ende` · datetime · Ende · required!
- `benoetigte_helfer` · number · Benötigte Helfer · required!
- `bemerkung` · textarea · Bemerkung
- `veranstaltung` · record · Veranstaltung · required! · → `veranstaltungen`
- `helfer` · multirecord · Helfer · → `mitglieder`
Input shapes: range `beginn`+`ende` (AvailabilityRangePicker)
